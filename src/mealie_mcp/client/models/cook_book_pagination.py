...
T = TypeVar("T", bound="CookBookPagination")


@_attrs_define
class CookBookPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cook_book_pagination.additional_properties = d
        return cook_book_pagination
