...
T = TypeVar("T", bound="RecipeCommentPagination")


@_attrs_define
class RecipeCommentPagination:
    """
    Attributes:
        items (list[RecipeCommentOutOutput]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = RecipeCommentOutOutput.from_dict(items_item_data)
        ...
        recipe_comment_pagination.additional_properties = d
        return recipe_comment_pagination
