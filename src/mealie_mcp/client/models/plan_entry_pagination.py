...
T = TypeVar("T", bound="PlanEntryPagination")


@_attrs_define
class PlanEntryPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.read_plan_entry import ReadPlanEntry  # noqa: PLC0415

        d = dict(src_dict)
        items = []
        _items = d.pop("items")
        for items_item_data in _items:
            items_item = ReadPlanEntry.from_dict(items_item_data)
        ...
        plan_entry_pagination.additional_properties = d
        return plan_entry_pagination
