...
T = TypeVar("T", bound="ShoppingListItemRecipeRefCreate")


@_attrs_define
class ShoppingListItemRecipeRefCreate:
    """
    Attributes:
        recipe_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        shopping_list_item_recipe_ref_create = cls(
            recipe_id=recipe_id,
        ...
        shopping_list_item_recipe_ref_create.additional_properties = d
        return shopping_list_item_recipe_ref_create
