...
T = TypeVar("T", bound="RecipeCategoryPagination")


@_attrs_define
class RecipeCategoryPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recipe_category_pagination = cls(
            items=items,
            page=page,
            per_page=per_page,
            total=total,
        ...
        recipe_category_pagination.additional_properties = d
        return recipe_category_pagination
