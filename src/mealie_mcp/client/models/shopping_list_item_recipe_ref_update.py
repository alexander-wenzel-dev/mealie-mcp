...
T = TypeVar("T", bound="ShoppingListItemRecipeRefUpdate")


@_attrs_define
class ShoppingListItemRecipeRefUpdate:
    """
    Attributes:
        recipe_id (str):
        id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        shopping_list_item_recipe_ref_update = cls(
            recipe_id=recipe_id,
            id=id,
        ...
        shopping_list_item_recipe_ref_update.additional_properties = d
        return shopping_list_item_recipe_ref_update
