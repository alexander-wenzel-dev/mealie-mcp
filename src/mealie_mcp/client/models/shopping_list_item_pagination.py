...
T = TypeVar("T", bound="ShoppingListItemPagination")


@_attrs_define
class ShoppingListItemPagination:
    """
    Attributes:
        items (list[ShoppingListItemOutOutput]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ShoppingListItemOutOutput.from_dict(items_item_data)
        ...
        shopping_list_item_pagination = cls(
            items=items,
            page=page,
            per_page=per_page,
            total=total,
        ...
        shopping_list_item_pagination.additional_properties = d
        return shopping_list_item_pagination
