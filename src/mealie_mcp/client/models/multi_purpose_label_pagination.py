...
T = TypeVar("T", bound="MultiPurposeLabelPagination")


@_attrs_define
class MultiPurposeLabelPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = MultiPurposeLabelSummary.from_dict(items_item_data)
        ...
        multi_purpose_label_pagination = cls(
            items=items,
            page=page,
            per_page=per_page,
            total=total,
        ...
        multi_purpose_label_pagination.additional_properties = d
        return multi_purpose_label_pagination
