...
class ShoppingListItemOut:
    ...
    Attributes:
        ...
        extras (None | ShoppingListItemOutExtrasType0 | Unset):
    ...
    unit: IngredientUnit | Unset | None = UNSET
    food: IngredientFood | Unset | None = UNSET
    ...
    extras: ShoppingListItemOutExtrasType0 | Unset | None = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.shopping_list_item_out_extras_type_0 import (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_unit(data: object) -> IngredientUnit | Unset | None:
            if data is None:
                return data
        ...
        def _parse_food(data: object) -> IngredientFood | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_extras(data: object) -> ShoppingListItemOutExtrasType0 | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
