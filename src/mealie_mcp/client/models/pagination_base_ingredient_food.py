...
T = TypeVar("T", bound="PaginationBaseIngredientFood")


@_attrs_define
class PaginationBaseIngredientFood:
    """
    Attributes:
        items (list[IngredientFoodOutput]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = IngredientFoodOutput.from_dict(items_item_data)
        ...
        pagination_base_ingredient_food = cls(
            items=items,
            page=page,
            per_page=per_page,
            total=total,
        ...
        pagination_base_ingredient_food.additional_properties = d
        return pagination_base_ingredient_food
