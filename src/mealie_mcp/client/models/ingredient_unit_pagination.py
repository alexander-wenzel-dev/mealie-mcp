...
T = TypeVar("T", bound="IngredientUnitPagination")
...
class IngredientUnitPagination:
    """
    Attributes:
        items (list[IngredientUnitOutput]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = IngredientUnitOutput.from_dict(items_item_data)
        ...
        ingredient_unit_pagination = cls(
            items=items,
            page=page,
            per_page=per_page,
            total=total,
        ...
        ingredient_unit_pagination.additional_properties = d
        return ingredient_unit_pagination
