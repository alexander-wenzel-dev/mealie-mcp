...
T = TypeVar("T", bound="GroupRecipeActionPagination")


@_attrs_define
class GroupRecipeActionPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = GroupRecipeActionOut.from_dict(items_item_data)
        ...
        group_recipe_action_pagination = cls(
            items=items,
            page=page,
            per_page=per_page,
            total=total,
        ...
        group_recipe_action_pagination.additional_properties = d
        return group_recipe_action_pagination
