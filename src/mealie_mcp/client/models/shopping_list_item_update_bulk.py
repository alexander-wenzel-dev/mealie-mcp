...
@_attrs_define
class ShoppingListItemUpdateBulk:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.extras, Unset):
            extras = UNSET
        elif isinstance(self.extras, ShoppingListItemUpdateBulkExtrasType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_extras(data: object) -> ShoppingListItemUpdateBulkExtrasType0 | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extras_type_0 = ShoppingListItemUpdateBulkExtrasType0.from_dict(data)

                return extras_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(None | ShoppingListItemUpdateBulkExtrasType0 | Unset, data)
        ...
        shopping_list_item_update_bulk = cls(
        ...
        shopping_list_item_update_bulk.additional_properties = d
        return shopping_list_item_update_bulk
