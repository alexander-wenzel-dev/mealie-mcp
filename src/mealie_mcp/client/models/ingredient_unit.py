...
class IngredientUnit:
    ...
    extras: IngredientUnitExtrasType0 | None | Unset = IngredientUnitExtrasType0()
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.extras, Unset):
            extras = UNSET
        elif isinstance(self.extras, IngredientUnitExtrasType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_extras(data: object) -> IngredientUnitExtrasType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extras_type_0 = IngredientUnitExtrasType0.from_dict(data)

                return extras_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(IngredientUnitExtrasType0 | None | Unset, data)
        ...
        ingredient_unit.additional_properties = d
