...
from ..models.recipe_output_extras_type_0 import RecipeOutputExtrasType0
...
T = TypeVar("T", bound="RecipeOutput")
...
class RecipeOutput:
    ...
    Attributes:
        ...
        recipe_ingredient (list[RecipeIngredientOutput] | Unset):
        recipe_instructions (list[RecipeStep] | None | Unset):
        nutrition (None | Nutrition | Unset):
        settings (None | RecipeSettings | Unset):
        assets (list[RecipeAsset] | None | Unset):
        notes (list[RecipeNote] | None | Unset):
        extras (None | RecipeOutputExtrasType0 | Unset):  Default: RecipeOutputExtrasType0().
        comments (list[RecipeCommentOutOutput] | None | Unset):
    """
    ...
    recipe_ingredient: list[RecipeIngredientOutput] | Unset = UNSET
    recipe_instructions: list[RecipeStep] | None | Unset = UNSET
    nutrition: None | Nutrition | Unset = UNSET
    settings: None | RecipeSettings | Unset = UNSET
    assets: list[RecipeAsset] | None | Unset = UNSET
    notes: list[RecipeNote] | None | Unset = UNSET
    extras: None | RecipeOutputExtrasType0 | Unset = RecipeOutputExtrasType0()
    comments: list[RecipeCommentOutOutput] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        recipe_ingredient: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.recipe_ingredient, Unset):
            recipe_ingredient = []
            for recipe_ingredient_item_data in self.recipe_ingredient:
                recipe_ingredient_item = recipe_ingredient_item_data.to_dict()
                recipe_ingredient.append(recipe_ingredient_item)

        recipe_instructions: list[dict[str, Any]] | None | Unset
        if isinstance(self.recipe_instructions, Unset):
            recipe_instructions = UNSET
        elif isinstance(self.recipe_instructions, list):
            recipe_instructions = []
            for recipe_instructions_type_0_item_data in self.recipe_instructions:
                recipe_instructions_type_0_item = recipe_instructions_type_0_item_data.to_dict()
                recipe_instructions.append(recipe_instructions_type_0_item)
        ...
        if isinstance(self.nutrition, Unset):
            nutrition = UNSET
        elif isinstance(self.nutrition, Nutrition):
        ...
        if isinstance(self.settings, Unset):
            settings = UNSET
        elif isinstance(self.settings, RecipeSettings):
            settings = self.settings.to_dict()
        else:
            settings = self.settings

        assets: list[dict[str, Any]] | None | Unset
        ...
        notes: list[dict[str, Any]] | None | Unset
        ...
        if isinstance(self.extras, Unset):
            extras = UNSET
        elif isinstance(self.extras, RecipeOutputExtrasType0):
        ...
        if recipe_ingredient is not UNSET:
            field_dict["recipeIngredient"] = recipe_ingredient
        if recipe_instructions is not UNSET:
            field_dict["recipeInstructions"] = recipe_instructions
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _recipe_ingredient = d.pop("recipeIngredient", UNSET)
        recipe_ingredient: list[RecipeIngredientOutput] | Unset = UNSET
        if _recipe_ingredient is not UNSET:
            recipe_ingredient = []
            for recipe_ingredient_item_data in _recipe_ingredient:
                recipe_ingredient_item = RecipeIngredientOutput.from_dict(
                    recipe_ingredient_item_data
                )

                recipe_ingredient.append(recipe_ingredient_item)

        def _parse_recipe_instructions(data: object) -> list[RecipeStep] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                recipe_instructions_type_0 = []
                _recipe_instructions_type_0 = data
                for recipe_instructions_type_0_item_data in _recipe_instructions_type_0:
                    recipe_instructions_type_0_item = RecipeStep.from_dict(
                        recipe_instructions_type_0_item_data
                    )

                    recipe_instructions_type_0.append(recipe_instructions_type_0_item)

                return recipe_instructions_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(list[RecipeStep] | None | Unset, data)

        recipe_instructions = _parse_recipe_instructions(d.pop("recipeInstructions", UNSET))

        def _parse_nutrition(data: object) -> None | Nutrition | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                nutrition_type_0 = Nutrition.from_dict(data)

                return nutrition_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(None | Nutrition | Unset, data)

        nutrition = _parse_nutrition(d.pop("nutrition", UNSET))

        def _parse_settings(data: object) -> None | RecipeSettings | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                settings_type_0 = RecipeSettings.from_dict(data)

                return settings_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(None | RecipeSettings | Unset, data)

        settings = _parse_settings(d.pop("settings", UNSET))

        def _parse_assets(data: object) -> list[RecipeAsset] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for assets_type_0_item_data in _assets_type_0:
                    assets_type_0_item = RecipeAsset.from_dict(assets_type_0_item_data)
                ...
                pass
            return cast(list[RecipeAsset] | None | Unset, data)

        assets = _parse_assets(d.pop("assets", UNSET))

        def _parse_notes(data: object) -> list[RecipeNote] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for notes_type_0_item_data in _notes_type_0:
                    notes_type_0_item = RecipeNote.from_dict(notes_type_0_item_data)
                ...
                pass
            return cast(list[RecipeNote] | None | Unset, data)

        notes = _parse_notes(d.pop("notes", UNSET))

        def _parse_extras(data: object) -> None | RecipeOutputExtrasType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extras_type_0 = RecipeOutputExtrasType0.from_dict(data)

                return extras_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(None | RecipeOutputExtrasType0 | Unset, data)

        extras = _parse_extras(d.pop("extras", UNSET))

        def _parse_comments(data: object) -> list[RecipeCommentOutOutput] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for comments_type_0_item_data in _comments_type_0:
                    comments_type_0_item = RecipeCommentOutOutput.from_dict(
                ...
                pass
            return cast(list[RecipeCommentOutOutput] | None | Unset, data)
        ...
        recipe_output.additional_properties = d
