...
class RecipeOutput:
    ...
    Attributes:
        ...
        extras (None | RecipeOutputExtrasType0 | Unset):
    ...
    recipe_instructions: list[RecipeStep] | Unset | None = UNSET
    nutrition: Nutrition | Unset | None = UNSET
    settings: RecipeSettings | Unset | None = UNSET
    assets: list[RecipeAsset] | Unset | None = UNSET
    notes: list[RecipeNote] | Unset | None = UNSET
    extras: RecipeOutputExtrasType0 | Unset | None = UNSET
    comments: list[RecipeCommentOutOutput] | Unset | None = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.nutrition import Nutrition  # noqa: PLC0415
        from ..models.recipe_output_extras_type_0 import RecipeOutputExtrasType0  # noqa: PLC0415
        ...
        recipe_instructions: list[dict[str, Any]] | Unset | None
        ...
        nutrition: dict[str, Any] | Unset | None
        ...
        assets: list[dict[str, Any]] | Unset | None
        ...
        notes: list[dict[str, Any]] | Unset | None
        ...
        comments: list[dict[str, Any]] | Unset | None
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_recipe_instructions(data: object) -> list[RecipeStep] | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_nutrition(data: object) -> Nutrition | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_settings(data: object) -> RecipeSettings | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_assets(data: object) -> list[RecipeAsset] | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_notes(data: object) -> list[RecipeNote] | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_extras(data: object) -> RecipeOutputExtrasType0 | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_comments(data: object) -> list[RecipeCommentOutOutput] | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
