...
T = TypeVar("T", bound="PaginationBaseHouseholdSummary")


@_attrs_define
class PaginationBaseHouseholdSummary:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.household_summary import HouseholdSummary  # noqa: PLC0415

        d = dict(src_dict)
        items = []
        _items = d.pop("items")
        for items_item_data in _items:
            items_item = HouseholdSummary.from_dict(items_item_data)
        ...
        pagination_base_household_summary = cls(
            items=items,
            page=page,
            per_page=per_page,
            total=total,
        ...
        pagination_base_household_summary.additional_properties = d
        return pagination_base_household_summary
