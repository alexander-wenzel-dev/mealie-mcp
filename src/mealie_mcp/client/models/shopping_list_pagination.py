...
T = TypeVar("T", bound="ShoppingListPagination")


@_attrs_define
class ShoppingListPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ShoppingListSummary.from_dict(items_item_data)
        ...
        shopping_list_pagination.additional_properties = d
        return shopping_list_pagination
