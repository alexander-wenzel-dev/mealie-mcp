...
class ShoppingListItemCreate:
    ...
    extras: None | ShoppingListItemCreateExtrasType0 | Unset = ShoppingListItemCreateExtrasType0()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_extras(data: object) -> None | ShoppingListItemCreateExtrasType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
