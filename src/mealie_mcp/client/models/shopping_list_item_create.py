...
T = TypeVar("T", bound="ShoppingListItemCreate")
...
class ShoppingListItemCreate:
    ...
    unit: CreateIngredientUnit | IngredientUnit | Unset | None = UNSET
    food: CreateIngredientFood | IngredientFood | Unset | None = UNSET
    referenced_recipe: Recipe | Unset | None = UNSET
    note: str | Unset | None = ""
    display: str | Unset = ""
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.extras, Unset):
            extras = UNSET
        elif isinstance(self.extras, ShoppingListItemCreateExtrasType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_unit(data: object) -> CreateIngredientUnit | IngredientUnit | Unset | None:
            if data is None:
                return data
        ...
        def _parse_food(data: object) -> CreateIngredientFood | IngredientFood | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_referenced_recipe(data: object) -> Recipe | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_extras(data: object) -> ShoppingListItemCreateExtrasType0 | Unset | None:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extras_type_0 = ShoppingListItemCreateExtrasType0.from_dict(data)

                return extras_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(None | ShoppingListItemCreateExtrasType0 | Unset, data)
        ...
        if _recipe_references is not UNSET:
            ...
            for recipe_references_item_data in _recipe_references:
                recipe_references_item = ShoppingListItemRecipeRefCreate.from_dict(
                    recipe_references_item_data
                )

                recipe_references.append(recipe_references_item)

        shopping_list_item_create = cls(
        ...
        shopping_list_item_create.additional_properties = d
        return shopping_list_item_create
