...
T = TypeVar("T", bound="PaginationBaseRecipeSummary")


@_attrs_define
class PaginationBaseRecipeSummary:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = RecipeSummary.from_dict(items_item_data)
        ...
        pagination_base_recipe_summary = cls(
            items=items,
            page=page,
            per_page=per_page,
            total=total,
        ...
        pagination_base_recipe_summary.additional_properties = d
        return pagination_base_recipe_summary
