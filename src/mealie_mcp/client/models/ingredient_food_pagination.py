...
T = TypeVar("T", bound="IngredientFoodPagination")
...
class IngredientFoodPagination:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ingredient_food_pagination = cls(
            items=items,
            page=page,
            per_page=per_page,
            total=total,
        ...
        ingredient_food_pagination.additional_properties = d
        return ingredient_food_pagination
