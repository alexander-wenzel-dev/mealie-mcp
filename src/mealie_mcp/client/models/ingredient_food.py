...
from ..models.ingredient_food_extras_type_0 import IngredientFoodExtrasType0
...
T = TypeVar("T", bound="IngredientFood")
...
class IngredientFood:
    ...
    Attributes:
        ...
        extras (IngredientFoodExtrasType0 | None | Unset):  Default: IngredientFoodExtrasType0().
    ...
    extras: IngredientFoodExtrasType0 | None | Unset = IngredientFoodExtrasType0()
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.extras, Unset):
            extras = UNSET
        elif isinstance(self.extras, IngredientFoodExtrasType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_extras(data: object) -> IngredientFoodExtrasType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extras_type_0 = IngredientFoodExtrasType0.from_dict(data)

                return extras_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(IngredientFoodExtrasType0 | None | Unset, data)
        ...
        ingredient_food.additional_properties = d
