...
T = TypeVar("T", bound="GroupPagination")
...
class GroupPagination:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = GroupInDB.from_dict(items_item_data)
        ...
        group_pagination.additional_properties = d
        return group_pagination
