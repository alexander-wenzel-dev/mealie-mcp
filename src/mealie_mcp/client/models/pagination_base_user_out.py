...
T = TypeVar("T", bound="PaginationBaseUserOut")


@_attrs_define
class PaginationBaseUserOut:
    """
    Attributes:
        items (list[UserOut]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = UserOut.from_dict(items_item_data)
        ...
        pagination_base_user_out.additional_properties = d
        return pagination_base_user_out
