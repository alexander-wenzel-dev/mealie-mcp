...
T = TypeVar("T", bound="RecipeToolPagination")


@_attrs_define
class RecipeToolPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recipe_tool_pagination.additional_properties = d
        return recipe_tool_pagination
