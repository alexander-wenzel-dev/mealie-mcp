...
T = TypeVar("T", bound="RecipeTagPagination")


@_attrs_define
class RecipeTagPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recipe_tag_pagination.additional_properties = d
        return recipe_tag_pagination
