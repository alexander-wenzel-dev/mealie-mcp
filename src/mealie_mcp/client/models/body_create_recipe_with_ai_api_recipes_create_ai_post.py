...
T = TypeVar("T", bound="BodyCreateRecipeWithAiApiRecipesCreateAiPost")


@_attrs_define
class BodyCreateRecipeWithAiApiRecipesCreateAiPost:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_create_recipe_with_ai_api_recipes_create_ai_post = cls(
            content=content,
            url=url,
        ...
        body_create_recipe_with_ai_api_recipes_create_ai_post.additional_properties = d
        return body_create_recipe_with_ai_api_recipes_create_ai_post
