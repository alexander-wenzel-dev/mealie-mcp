...
class Recipe:
    ...
    Attributes:
        ...
        recipe_ingredient (list[RecipeIngredient] | Unset):
    ...
    recipe_ingredient: list[RecipeIngredient] | Unset = UNSET
    ...
    extras: None | RecipeExtrasType0 | Unset = RecipeExtrasType0()
    comments: list[RecipeCommentOut] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.extras, Unset):
            extras = UNSET
        elif isinstance(self.extras, RecipeExtrasType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _recipe_ingredient is not UNSET:
            ...
            for recipe_ingredient_item_data in _recipe_ingredient:
                recipe_ingredient_item = RecipeIngredient.from_dict(recipe_ingredient_item_data)
        ...
        def _parse_extras(data: object) -> None | RecipeExtrasType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extras_type_0 = RecipeExtrasType0.from_dict(data)

                return extras_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(None | RecipeExtrasType0 | Unset, data)

        extras = _parse_extras(d.pop("extras", UNSET))

        def _parse_comments(data: object) -> list[RecipeCommentOut] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for comments_type_0_item_data in _comments_type_0:
                    comments_type_0_item = RecipeCommentOut.from_dict(comments_type_0_item_data)
                ...
                pass
            return cast(list[RecipeCommentOut] | None | Unset, data)
