...
T = TypeVar("T", bound="ShoppingListAddRecipeParamsBulk")


@_attrs_define
class ShoppingListAddRecipeParamsBulk:
    """
    Attributes:
        recipe_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        shopping_list_add_recipe_params_bulk = cls(
            recipe_id=recipe_id,
            recipe_increment_quantity=recipe_increment_quantity,
            recipe_ingredients=recipe_ingredients,
        )

        shopping_list_add_recipe_params_bulk.additional_properties = d
        return shopping_list_add_recipe_params_bulk
