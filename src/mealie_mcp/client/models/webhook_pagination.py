...
T = TypeVar("T", bound="WebhookPagination")
...
class WebhookPagination:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ReadWebhook.from_dict(items_item_data)
        ...
        webhook_pagination.additional_properties = d
        return webhook_pagination
