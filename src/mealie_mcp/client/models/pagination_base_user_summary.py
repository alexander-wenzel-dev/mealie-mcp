...
T = TypeVar("T", bound="PaginationBaseUserSummary")


@_attrs_define
class PaginationBaseUserSummary:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pagination_base_user_summary = cls(
            items=items,
            page=page,
            per_page=per_page,
            total=total,
        ...
        pagination_base_user_summary.additional_properties = d
        return pagination_base_user_summary
