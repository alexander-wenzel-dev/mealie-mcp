...
T = TypeVar("T", bound="RecipeIngredientSubstitution")


@_attrs_define
class RecipeIngredientSubstitution:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recipe_ingredient_substitution = cls(
            substitute_food_id=substitute_food_id,
            note=note,
            substitute_food=substitute_food,
        )

        recipe_ingredient_substitution.additional_properties = d
        return recipe_ingredient_substitution
