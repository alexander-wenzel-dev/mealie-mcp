...
T = TypeVar("T", bound="GroupEventPagination")


@_attrs_define
class GroupEventPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.group_event_notifier_out import GroupEventNotifierOut  # noqa: PLC0415

        d = dict(src_dict)
        items = []
        _items = d.pop("items")
        for items_item_data in _items:
            items_item = GroupEventNotifierOut.from_dict(items_item_data)
        ...
        group_event_pagination.additional_properties = d
        return group_event_pagination
