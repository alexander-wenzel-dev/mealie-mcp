...
T = TypeVar("T", bound="PaginationBaseReadCookBook")


@_attrs_define
class PaginationBaseReadCookBook:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ReadCookBook.from_dict(items_item_data)
        ...
        pagination_base_read_cook_book = cls(
            items=items,
            page=page,
            per_page=per_page,
            total=total,
        ...
        pagination_base_read_cook_book.additional_properties = d
        return pagination_base_read_cook_book
