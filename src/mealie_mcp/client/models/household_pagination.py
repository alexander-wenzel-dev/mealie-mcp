...
T = TypeVar("T", bound="HouseholdPagination")


@_attrs_define
class HouseholdPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = HouseholdInDB.from_dict(items_item_data)
        ...
        household_pagination.additional_properties = d
        return household_pagination
