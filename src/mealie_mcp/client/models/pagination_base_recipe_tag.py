...
T = TypeVar("T", bound="PaginationBaseRecipeTag")


@_attrs_define
class PaginationBaseRecipeTag:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = RecipeTag.from_dict(items_item_data)
        ...
        pagination_base_recipe_tag = cls(
            items=items,
            page=page,
            per_page=per_page,
            total=total,
        ...
        pagination_base_recipe_tag.additional_properties = d
        return pagination_base_recipe_tag
