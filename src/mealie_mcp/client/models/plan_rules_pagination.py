...
T = TypeVar("T", bound="PlanRulesPagination")


@_attrs_define
class PlanRulesPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = PlanRulesOut.from_dict(items_item_data)
        ...
        plan_rules_pagination.additional_properties = d
        return plan_rules_pagination
