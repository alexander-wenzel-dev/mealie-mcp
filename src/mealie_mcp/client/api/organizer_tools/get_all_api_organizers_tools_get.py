...
from ...models.recipe_tool_pagination import RecipeToolPagination
...
) -> HTTPValidationError | RecipeToolPagination | None:
    if response.status_code == 200:
        response_200 = RecipeToolPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | RecipeToolPagination]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | RecipeToolPagination
    """
