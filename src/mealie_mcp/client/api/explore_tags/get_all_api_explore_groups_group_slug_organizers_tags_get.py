...
from ...models.pagination_base_recipe_tag import PaginationBaseRecipeTag
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/explore/groups/{group_slug}/organizers/tags".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PaginationBaseRecipeTag.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | PaginationBaseRecipeTag
    """
