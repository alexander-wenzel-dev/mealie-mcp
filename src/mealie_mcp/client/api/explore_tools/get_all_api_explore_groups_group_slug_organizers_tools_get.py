...
from ...models.pagination_base_recipe_tool import PaginationBaseRecipeTool
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/explore/groups/{group_slug}/organizers/tools".format(
...
) -> HTTPValidationError | PaginationBaseRecipeTool | None:
    if response.status_code == 200:
        response_200 = PaginationBaseRecipeTool.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | PaginationBaseRecipeTool]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | PaginationBaseRecipeTool
    """
