...
from ...models.maintenance_storage_details import MaintenanceStorageDetails
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = MaintenanceStorageDetails.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | MaintenanceStorageDetails
    """
