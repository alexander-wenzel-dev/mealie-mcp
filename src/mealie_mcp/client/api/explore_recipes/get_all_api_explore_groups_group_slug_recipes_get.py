...
def _get_kwargs(
    ...
    *,
    ...
    json_categories: list[str] | Unset | None
    ...
    json_households: list[str] | Unset | None
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/explore/groups/{group_slug}/recipes".format(
