...
from ...models.pagination_base_user_summary import PaginationBaseUserSummary
...
) -> HTTPValidationError | PaginationBaseUserSummary | None:
    if response.status_code == 200:
        response_200 = PaginationBaseUserSummary.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | PaginationBaseUserSummary]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | PaginationBaseUserSummary
    """
