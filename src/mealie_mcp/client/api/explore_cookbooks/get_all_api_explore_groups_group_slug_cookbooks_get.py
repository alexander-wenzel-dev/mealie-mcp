...
from ...models.pagination_base_read_cook_book import PaginationBaseReadCookBook
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/explore/groups/{group_slug}/cookbooks".format(
...
) -> HTTPValidationError | PaginationBaseReadCookBook | None:
    if response.status_code == 200:
        response_200 = PaginationBaseReadCookBook.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | PaginationBaseReadCookBook]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | PaginationBaseReadCookBook
    """
