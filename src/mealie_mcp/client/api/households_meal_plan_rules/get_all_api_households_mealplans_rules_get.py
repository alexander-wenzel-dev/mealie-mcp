...
from ...models.plan_rules_pagination import PlanRulesPagination
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PlanRulesPagination.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | PlanRulesPagination
    """
