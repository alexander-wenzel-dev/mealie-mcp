...
from ...models.shopping_list_add_recipe_params import ShoppingListAddRecipeParams
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/households/shopping/lists/{item_id}/recipe/{recipe_id}".format(
            item_id=quote(str(item_id), safe=""),
            recipe_id=quote(str(recipe_id), safe=""),
        ),
    }

    if isinstance(body, ShoppingListAddRecipeParams):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (None | ShoppingListAddRecipeParams | Unset):
