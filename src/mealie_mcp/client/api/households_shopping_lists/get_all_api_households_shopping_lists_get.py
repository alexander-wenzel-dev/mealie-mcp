...
from ...models.shopping_list_pagination import ShoppingListPagination
...
) -> HTTPValidationError | ShoppingListPagination | None:
    if response.status_code == 200:
        response_200 = ShoppingListPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ShoppingListPagination]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ShoppingListPagination
    """
