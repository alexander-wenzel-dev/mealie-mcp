...
from ...models.webhook_pagination import WebhookPagination
...
) -> HTTPValidationError | WebhookPagination | None:
    if response.status_code == 200:
        response_200 = WebhookPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | WebhookPagination]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | WebhookPagination
    """
