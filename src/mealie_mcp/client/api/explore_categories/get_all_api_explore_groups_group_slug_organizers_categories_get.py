...
from ...models.pagination_base_recipe_category import PaginationBaseRecipeCategory
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/explore/groups/{group_slug}/organizers/categories".format(
...
) -> HTTPValidationError | PaginationBaseRecipeCategory | None:
    if response.status_code == 200:
        response_200 = PaginationBaseRecipeCategory.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | PaginationBaseRecipeCategory]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | PaginationBaseRecipeCategory
    """
