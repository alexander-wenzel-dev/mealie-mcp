...
from ...models.multi_purpose_label_pagination import MultiPurposeLabelPagination
...
) -> HTTPValidationError | MultiPurposeLabelPagination | None:
    if response.status_code == 200:
        response_200 = MultiPurposeLabelPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | MultiPurposeLabelPagination]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | MultiPurposeLabelPagination
    """
