...
from ...models.recipe_timeline_event_pagination import RecipeTimelineEventPagination
...
) -> HTTPValidationError | RecipeTimelineEventPagination | None:
    if response.status_code == 200:
        response_200 = RecipeTimelineEventPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | RecipeTimelineEventPagination]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | RecipeTimelineEventPagination
    """
