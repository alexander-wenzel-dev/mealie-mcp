...
from ...models.recipe_timeline_event_update import RecipeTimelineEventUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/recipes/timeline/events/{item_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = RecipeTimelineEventOut.from_dict(response.json())
