...
from ...models.plan_entry_pagination import PlanEntryPagination
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PlanEntryPagination.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | PlanEntryPagination
    """
