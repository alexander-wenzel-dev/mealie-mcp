...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/admin/users/{item_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UserOut):  Example: {'admin': 'false', 'email': 'changeme@example.com', 'fullName':
            'Change Me', 'group': 'Home', 'household': 'Family', 'username': 'ChangeMe'}.
