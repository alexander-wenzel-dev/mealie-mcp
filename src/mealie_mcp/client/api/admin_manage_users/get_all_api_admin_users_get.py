...
from ...models.user_pagination import UserPagination
...
) -> HTTPValidationError | UserPagination | None:
    if response.status_code == 200:
        response_200 = UserPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | UserPagination]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | UserPagination
    """
