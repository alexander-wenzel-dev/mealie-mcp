...
from ...models.household_pagination import HouseholdPagination
...
) -> HTTPValidationError | HouseholdPagination | None:
    if response.status_code == 200:
        response_200 = HouseholdPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | HouseholdPagination]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | HouseholdPagination
    """
