...
from ...models.group_pagination import GroupPagination
...
) -> GroupPagination | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = GroupPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GroupPagination | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        GroupPagination | HTTPValidationError
    """
