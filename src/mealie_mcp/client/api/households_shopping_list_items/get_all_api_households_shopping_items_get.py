...
from ...models.shopping_list_item_pagination import ShoppingListItemPagination
...
) -> HTTPValidationError | ShoppingListItemPagination | None:
    if response.status_code == 200:
        response_200 = ShoppingListItemPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ShoppingListItemPagination]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ShoppingListItemPagination
    """
