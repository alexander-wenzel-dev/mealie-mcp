...
from ...models.shopping_list_item_create import ShoppingListItemCreate
...
def _get_kwargs(
    *,
    body: list[ShoppingListItemCreate],
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ShoppingListItemsCollectionOut.from_dict(response.json())
