...
from ...models.cook_book_pagination import CookBookPagination
...
) -> CookBookPagination | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = CookBookPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CookBookPagination | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        CookBookPagination | HTTPValidationError
    """
