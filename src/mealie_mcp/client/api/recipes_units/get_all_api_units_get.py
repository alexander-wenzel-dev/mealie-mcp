...
from ...models.ingredient_unit_pagination import IngredientUnitPagination
...
) -> HTTPValidationError | IngredientUnitPagination | None:
    if response.status_code == 200:
        response_200 = IngredientUnitPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | IngredientUnitPagination]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | IngredientUnitPagination
    """
