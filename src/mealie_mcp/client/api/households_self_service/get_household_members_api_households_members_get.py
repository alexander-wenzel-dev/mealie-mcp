...
from ...models.pagination_base_user_out import PaginationBaseUserOut
...
) -> HTTPValidationError | PaginationBaseUserOut | None:
    if response.status_code == 200:
        response_200 = PaginationBaseUserOut.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | PaginationBaseUserOut]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | PaginationBaseUserOut
    """
