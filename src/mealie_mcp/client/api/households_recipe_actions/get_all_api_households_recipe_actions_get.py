...
from ...models.group_recipe_action_pagination import GroupRecipeActionPagination
...
) -> GroupRecipeActionPagination | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = GroupRecipeActionPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GroupRecipeActionPagination | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        GroupRecipeActionPagination | HTTPValidationError
    """
