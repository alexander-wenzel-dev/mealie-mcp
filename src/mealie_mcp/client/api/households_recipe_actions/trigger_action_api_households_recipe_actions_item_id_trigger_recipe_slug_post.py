...
from ...models.body_trigger_action_api_households_recipe_actions_item_id_trigger_recipe_slug_post import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/households/recipe-actions/{item_id}/trigger/{recipe_slug}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (BodyTriggerActionApiHouseholdsRecipeActionsItemIdTriggerRecipeSlugPost | Unset):
