...
) -> FormatResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = FormatResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[FormatResponse | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        FormatResponse | HTTPValidationError
    """
