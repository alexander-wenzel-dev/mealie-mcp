...
from ...models.group_event_pagination import GroupEventPagination
...
) -> GroupEventPagination | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = GroupEventPagination.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GroupEventPagination | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        GroupEventPagination | HTTPValidationError
    """
