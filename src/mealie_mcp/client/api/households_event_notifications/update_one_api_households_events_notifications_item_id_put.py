...
from ...models.group_event_notifier_update import GroupEventNotifierUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/households/events/notifications/{item_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GroupEventNotifierOut.from_dict(response.json())
